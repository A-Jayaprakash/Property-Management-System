            ...
            <div class="tenant-details">
              ...
              ${
                ...
                <div class="detail-row" style="color: #ff6b6b;">
                  <span class="detail-label">${getDaysRemaining(tenant.leaseEndDate) < 0 ? "Lease Status:" : "Days Remaining:"}</span>
                  <span class="detail-value">${getDaysRemaining(tenant.leaseEndDate) < 0 ? "Expired" : `${getDaysRemaining(tenant.leaseEndDate)} days`}</span>
                </div>
              `
                  : ""
              }
